                ...
                while (true) {
                    ...
                    try {
                        ...
                        if (amount > 0) {
                            ...
                            System.out.println("Invalid input: Expense should be greater than 0. Please try again.");
                        }
                    } catch (NumberFormatException e) {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (targetAmount > 0) {
                        ...
                        System.out.println("Invalid input: Savings goal amount should be greater than 0. Please try again.");
                    }
                } catch (NumberFormatException e) {
                    System.out.println("Invalid input: Please enter a valid number.");
                }
            ...
            while (true) {
                ...
                try {
                    ...
                    if (currentSaved > 0) {
                        ...
                        System.out.println("Invalid input: Current savings should be greater than or equal to 0.");
                    }
                } catch (NumberFormatException e) {
                    System.out.println("Invalid input: Pleaser enter a valid number.");
                }
